  ...
  return (
    <section className="relative bg-primary overflow-visible pb-unit-32">
      ...
      <div className="container">
        <div
          className={cn(
            "grid grid-rows-2 lg:grid-rows-1 lg:grid-cols-2 items-center py-unit-60",
        ...
        >
          <div className="text-center leading-normal">
            ...
            <p className="text-2xl">
              <Counter value={2395732} damping={350} /> 人贊助
            </p>
          </div>
          <div className="text-center leading-normal">
        ...
        <div className="flex flex-col lg:flex-row justify-between lg:items-stretch gap-unit-5 w-full">
